...
void CLI_monitorIMU(void)
{
   ...
   while(1)
   {
       ...
       //remove \r to keep previous lines of data (Column format)
       SF_OSAL_printf("\r%8.4f\t%8.4f\t%8.4f\t%8.4f\t%8.4f\t%8.4f\t%8.4f\t%8.4f\t%8.4f", accelData[0], accelData[1], accelData[2], gyroData[0], gyroData[1], gyroData[2], magData[0], magData[1], magData[2]);
       delay(500);
   }
}
