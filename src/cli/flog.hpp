...
#define FLOG_PARAM_FMT      PRIX32
    ...
    typedef enum FLOG_CODE_
    {
        ...
        FLOG_RESET_REASON_DATA = 0x0109,
        FLOG_SYS_STARTSTATE_JUSTIFICATION = 0x010A,
        FLOG_SYS_SLEEP = 0x010B,
        ...
        FLOG_REC_OPEN_LAST_SESSION_FAIL = 0x0813,
        FLOG_REC_INVALID_METADATA = 0x0814,
        FLOG_REC_DOUBLE_OPEN = 0x0815,
        FLOG_REC_OPEN_SESSION_FAIL = 0x0816,
        FLOG_REC_COMMIT_FAIL = 0x0817,
        FLOG_REC_COMMIT_BLE_FAIL = 0x0818,
        FLOG_COMMIT_INVALID_ARG = 0x081A,
        FLOG_COMMIT_RECORD_FAIL = 0x081B,
        FLOG_COMMIT_STREAM_FAIL = 0x081C,

        FLOG_REC_FORMAT_OPEN = 0x0820,
        FLOG_REC_FORMAT_RM_FILE = 0x0821,
        FLOG_REC_RMTREE_RM_FILE = 0x0822,
        FLOG_REC_RMTREE_READDIR = 0x0823,
        FLOG_REC_RMTREE_RMDIR = 0x0824,
        FLOG_REC_RMTREE_OPENDIR = 0x0825,
        FLOG_REC_FORMAT_RMTREE = 0x0826,

        FLOG_CELL_DISCONN_FAIL = 0x0900,
        FLOG_CELL_CONNECT_FAIL_ATTEMPT_EXCEEDED = 0x0910,
        FLOG_CELL_CONNECT_FAIL_TIMEOUT = 0x0911,

        FLOG_WS_OUT_OF_WATER = 0x0A00,
        FLOG_WS_IN_WATER = 0x0A01,
