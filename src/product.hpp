 ...
 */
#define SF_CLI_RGB_LED_COLOR        SF_HAL::color::RED
 ...
 */
#define RIDE_RGB_LED_COLOR SF_HAL::color::WHITE
 ...
 */
#define SF_DUP_RGB_LED_COLOR        SF_HAL::color::BLUE
...
#define SF_TCAL_RGB_LED_COLOR       SF_HAL::color::ORANGE
