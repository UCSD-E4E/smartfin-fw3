...
void NVRAM::displayNVRAM(void)
{
    ...
    SF_OSAL_printf("NVRAM Valid: 0x%02hhx" __NL__, u8);
    this->get(BOOT_BEHAVIOR, u8);
    SF_OSAL_printf("Boot Behavior: 0x%02hhx" __NL__, u8);
    this->get(TMP116_CAL_VALUE, u16);
    SF_OSAL_printf("TMP116 Cal Value: 0x%04hx" __NL__, u16);
    this->get(TMP116_CAL_CURRENT_ATTEMPT, u8);
    SF_OSAL_printf("TMP116 Cal Current Attempt: 0x%02hhx" __NL__, u8);
    this->get(TMP116_CAL_ATTEMPTS_TOTAL, u8);
    SF_OSAL_printf("TMP116 Cal Total Attempts: 0x%02hhx" __NL__, u8);
    ...
    SF_OSAL_printf("Upload Reattempts: 0x%02hhx" __NL__, u8);
    this->get(NO_UPLOAD_FLAG, u8);
    SF_OSAL_printf("No Upload Flag: 0x%02hhx" __NL__, u8);
}