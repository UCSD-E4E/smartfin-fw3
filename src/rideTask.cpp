...
DeploymentSchedule_t deploymentSchedule[] = {
    ...
    // temp + wet/dry
    // {SS_Ensemble01_Func,        SS_Ensemble01_Func,        1,          100,        2,         0,      "Temp",       {0}},
    // {SS_ensemble07Func,         SS_ensemble07Init,         1,          100,        2,         0,      "Battery",    {0}},
    // {SS_ensemble08Func,         SS_ensemble08Init,         1,          100,        2,         0,      "Temp+Epoch", {0}},
    {SS_ensemble10Func,         SS_ensemble10Init,         1,          100,        2,         0,      "Temp+IMUx3", {0}},
    // {SS_Ensemble12_x0C_Func,    SS_Ensemble12_x0C_Init,    1,          100,        2,         0,      "HDR IMU",    {0}},
