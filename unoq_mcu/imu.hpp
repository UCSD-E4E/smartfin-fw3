/**
 * @file imu.hpp
 * @brief Lightweight ICM-20948 I2C driver for the STM32U585 MCU.
 */
...
/**
 * @brief Initialize the ICM-20948 sensor over I2C4.
 *
 * Checks WHO_AM_I (0xEA), resets and wakes the chip, and enables
 * the 3-axis accelerometer and 3-axis gyroscope.
 *
 ...
 *
 * Reads 12 contiguous registers starting at ACCEL_XOUT_H (0x2D) over I2C4
