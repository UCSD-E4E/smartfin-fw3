...
uint8_t quectelGPS::getSatellites()
{
    return _gpsParser.sats_in_use;
}


uint8_t quectelGPS::getSatellitesDesc(gps_sat_t desc[])
{

    for( uint32_t ii = 0; ii < _gpsParser.sats_in_view; ii++ )
    {
    ...
    return _gpsParser.sats_in_view;
}
